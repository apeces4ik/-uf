              ...
              <div>
                ...
                <div className="bg-white p-3 rounded-lg shadow-md mb-6">
                  <div className="h-64 bg-gray-200 rounded overflow-hidden relative">
                    {/* This is a placeholder for the map. In a real implementation, you would embed a Google/Yandex map here */}
                    <div className="absolute inset-0 flex items-center justify-center text-gray-500">
                      <div className="text-center">
                        <MapPin className="h-12 w-12 mx-auto mb-2" />
                        <p className="text-sm">Интерактивная карта</p>
                        <p className="text-xs mt-2">ул. Спортивная 15, г. Александрия</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Билеты на матч" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <Button 
                        type="submit" 
                        className="w-full bg-primary hover:bg-secondary-blue"
